...
public class RandomizedSet {
    ...
    protected List<Integer> listSet;     // elements
    protected Map<Integer, Integer> map; // element, address in the list
    ...
    public boolean remove(int val) {
        ...
        int lastElement = listSet.get(listSet.size() - 1);

        // Перемещаем последний элемент на место удаляемого
        listSet.set(index, lastElement);
        map.put(lastElement, index);

        // Удаляем последний элемент из списка и мапы
